...
const RELEASE_INFO_V2_2 = {
    ...
    content: <>
        ...
        <p><img border="1" src="/assets/images/sites/release_notes/v2.2/email_validation.png" /></p>
        <p><img border="1" src="/assets/images/sites/release_notes/v2.2/blog_request_input.png" /></p>
