...
const REPORT_INFO_2024 = {
    ...
    content: <>
        ...
        <p><i>「个人感觉理论派的文章属于很有深度、很严肃的类型，该博主也是博友圈里非常难得的洞见型、思考型作者。从文章内容来看，该博主对于法律、历史、文化等有非常深入的研究，每篇文章涉及的知识面非常广，古今中外的典籍信手拈来。尽管博主的知识储备非常深厚，但不是为了求新求异而写文章，而是举实例、说来由，拜读几篇该博主的文章，您会从中感受到博主有一种忧国忧民的大气魄。」</i></p>
    </>,
