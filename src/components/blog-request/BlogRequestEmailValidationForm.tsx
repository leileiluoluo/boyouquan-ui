...
export default function BlogRequestEmailValidationForm({ formData, error, adminEmailInputRef, sendCodeInputRef, emailValidationCodeInputRef, emailValidationButtonRef, handleChange, handleValidationButtonClick, handleSubmit, isAdminPage }: BlogRequestEmailValidationFormProps): React.JSX.Element {
    return (
        <>
            {
