function lightenColor(rgb: [number, number, number], brightnessFactor: number = 1.2, saturationFactor: number = 0.8): [number, number, number] {
    let [r, g, b] = rgb;
...
export function setBackgroundFromAvatar(elementId: string, avatarUrl: string): void {
    const img = new Image();
