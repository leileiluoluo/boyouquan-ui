        ...
        <Box>
            <Form>
                <Flex gap="2" align="center" justify="between">
                    <Box width="100%">
                        <TextField.Root style={{ fontSize: '12px' }} name="email" placeholder="输入邮箱并订阅，次月首日将自动收到上月精选文章" id="email" value={email} onChange={handleChange} />
                    </Box>
                    <GlobalDialog
                        title={'' != error.code ? '错误提示' : '提示'}
                        titleColor={'' != error.code ? 'crimson' : ''}
                        message={'' != error.code ? error.message : `您的邮箱 ${email} 已成功订阅「每月精选」频道，您会在每个月底自动收到精选文章邮件！刚刚已将上个月的精选文章发到了您的邮箱，请注意查看！`}
